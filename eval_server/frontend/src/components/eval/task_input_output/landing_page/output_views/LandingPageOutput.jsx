...
function LandingPageOutput({ output, hasHtmlPreview = true, onViewPreview }) {
  ...
  return (
    <div className="eval-section output-section">
      ...
      {output.autopopulation_results && (
        <div className="output-cards">
          <OutputCard
            label="Autopopulation Results"
            value={output.autopopulation_results}
            isCollapsible
            fullWidth
          />
        </div>
